...
@Component({
    ...
    template: `
        ...
        <mat-dialog-actions align="end">
            ...
            <button mat-stroked-button (click)="onChoice('instance')">
                Nur diesen Termin
            </button>
            <button mat-flat-button (click)="onChoice('series')">
                Die gesamte Serie
            </button>
        </mat-dialog-actions>
    `,
...
export class RecurrenceChoiceDialogComponent {
    constructor(
        private dialogRef: MatDialogRef<RecurrenceChoiceDialogComponent>,
    ) {}
