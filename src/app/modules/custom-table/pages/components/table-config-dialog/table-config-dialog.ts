            ...
            case 'CreateTable':
                const createDto: UpsertTableDto = {
                    ...
                    column: {
                        ...
                        dataType: this.form.value
                            .columnDataType as CustomDataType,
                        colOrder: 0,
                    },
                };
                    ...
                    this.dialog
                        .open(ConfirmDialogComponent, {
                            data: {
                                ...
                                message:
                                    'Wenn Sie den Datentyp ändern, können die bestehenden Daten in dieser Spalte verloren gehen. Möchten Sie fortfahren?',
                                confirmText: 'Ändern',
        ...
        this.dialog
            .open(ConfirmDialogComponent, {
                data: {
                    ...
                    message:
                        'Möchten Sie diese Spalte wirklich löschen? Alle Daten in dieser Spalte gehen verloren.',
                    confirmText: 'Löschen',
                    isDestructive: true,
                },
            })
